...
export default function Interests() {
  return (
    <section className="flow | text-neutral-100 bg-neutral-900 text-center" id="interests">
      ...
      <div className={styles["interests"]}>
        <article className={`flow ${styles["interest"]}`} data-theme="cooking">
          ...
          <p>
            What best to do after a rushed day of work than to put on some chill cooking beats and
            fill the room with savoury aroma. Follow along to see things I&apos;ve been cooking.
          </p>
        ...
        <article className={`flow ${styles["interest"]}`} data-theme="art">
          ...
          <p>
            To remain creative, to test new boundaries and constantly try out new techniques is what
            I learn from painting with watercolours. Here are some of my creations.
          </p>
          <Link href="" className="button" data-variant="primary">
            Learn more
          </Link>
        ...
        <article className={`flow ${styles["interest"]}`} data-theme="travel">
          ...
          <p>
            Explore new horizons, try out new food and learn about different cultures. See where
            I&apos;ve been.
          </p>
          <Link href="" className="button" data-variant="primary">
            Learn more
        ...
        <article className={`flow ${styles["interest"]}`} data-theme="running">
          ...
          <p>
            Why would anyone tire themselves out for no reason? Well I guess because people say it
            relieves stress? Learn about why I run.
          </p>
          <Link href="" className="button" data-variant="primary">
            Learn more
          </Link>
