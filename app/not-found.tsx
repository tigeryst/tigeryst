    ...
    <div className="flex flex-col items-center justify-center | p-8 min-h-[50vh] | gap-8">
      <div className="text-center max-w-[600px]">
        ...
        <p className="text-neutral-400 leading-relaxed">
          Hi! Looks like you landed on a page that does not yet exist. It is highly likely that I am
          still working on the page (this site is a work in progress) or it is temporarily
          unavailable. Check your URL or{" "}
